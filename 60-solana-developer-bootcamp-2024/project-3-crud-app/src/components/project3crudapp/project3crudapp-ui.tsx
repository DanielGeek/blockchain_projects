...
export function Project3crudappCreate() {
  const { initialize } = useProject3crudappProgram()
...
function Project3crudappCard({ account }: { account: PublicKey }) {
  const { accountQuery, incrementMutation, setMutation, decrementMutation, closeMutation } = useProject3crudappProgramAccount({
    account,
  })
